...
public:
    ...
    TEST_METHOD_PRERELEASE(GenericRxChecksumOffloadConfigAttachInterfaceAndProgram) {
        ::GenericRxChecksumOffloadConfig(TRUE);
    }

    TEST_METHOD_PRERELEASE(GenericRxChecksumOffloadConfigDoNotAttachInterfaceAndProgram) {
