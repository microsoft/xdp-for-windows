...
static_assert(XDP_LWF_GENERIC_INSPECT_FLAG_DISPATCH == NDIS_RECEIVE_FLAGS_DISPATCH_LEVEL,
               "XDP_LWF_GENERIC_INSPECT_FLAG_DISPATCH must match NDIS_RECEIVE_FLAGS_DISPATCH_LEVEL");
static_assert(XDP_LWF_GENERIC_INSPECT_FLAG_DISPATCH == NDIS_SEND_FLAGS_DISPATCH_LEVEL,
               "XDP_LWF_GENERIC_INSPECT_FLAG_DISPATCH must match NDIS_SEND_FLAGS_DISPATCH_LEVEL");
static_assert(XDP_LWF_GENERIC_INSPECT_FLAG_RESOURCES == NDIS_RECEIVE_FLAGS_RESOURCES,
